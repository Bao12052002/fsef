...
<html lang="vi">
	...
	<title>Đăng nhập &lsaquo; Apple &#8212; WordPress</title>
		...
		<form name="loginform" id="loginform" action="./" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Đăng nhập">
					...
					<p id="nav">
				<a href="./?action=register">Đăng ký</a> | 				<a href="./tai-khoan/lost-password/index.html">Bạn quên mật khẩu?</a>
			</p>
					<script type="text/javascript">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Quay lại Apple</a>		</p>
			</div>
...
/* <![CDATA[ */
var userProfileL10n = {"user_id":"0","nonce":"cd767f7e98"};
/* ]]> */
</script>
